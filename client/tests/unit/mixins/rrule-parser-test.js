...
test('parsing yearly rrule interval with until date', function() {
  ...
  var text1 = subject.recurrenceRuleToText(
    'FREQ=YEARLY;DTSTART=20150309T200100Z;UNTIL=20171030T220000Z;INTERVAL=4;WKST=MO;BYDAY=MO,TU,WE,TH,FR',
    '+0300');
  ...
  var text2 = subject.recurrenceRuleToText(
    'FREQ=YEARLY;DTSTART=20150309T200100Z;UNTIL=20171030T220000Z;COUNT=30;INTERVAL=4;WKST=MO;BYDAY=MO,TU,WE,TH,FR',
    '+0300');
  ...
  var text3 = subject.recurrenceRuleToText(
    'FREQ=YEARLY;DTSTART=20150309T200100Z;COUNT=30;INTERVAL=1;WKST=MO',
    '+0300');
...
test('parsing yearly rrule interval', function() {
  ...
  var text5 = subject.recurrenceRuleToText(
    'FREQ=YEARLY;DTSTART=20150305T210000Z;WKST=MO;BYDAY=TU,TH,FR;BYMONTH=2',
    '+0300');
...
test('parsing hourly rrule interval', function() {
  ...
  var text1 = subject.recurrenceRuleToText(
    'FREQ=HOURLY;DTSTART=20150305T210000Z;INTERVAL=4;WKST=MO',
    '+0300');
  equal(text1, 'Every 4 hours starting on March 6th 2015 at 12:00:00 AM +03:00');
  var text2 = subject.recurrenceRuleToText(
    'FREQ=HOURLY;DTSTART=20150305T210000Z;INTERVAL=1;WKST=MO',
    '+0300');
  equal(text2, 'Every hour starting on March 6th 2015 at 12:00:00 AM +03:00');
  var text3 = subject.recurrenceRuleToText(
    'FREQ=HOURLY;DTSTART=20150305T210000Z;WKST=MO',
    '+0300');
  equal(text3, 'Every hour starting on March 6th 2015 at 12:00:00 AM +03:00');
  var text4 = subject.recurrenceRuleToText(
    'FREQ=HOURLY;DTSTART=20150305T210000Z;WKST=MO;BYDAY=TU,TH,FR',
    '+0300');
...
test('parsing minutely rrule interval', function() {
  ...
  var text1 = subject.recurrenceRuleToText(
    'FREQ=MINUTELY;DTSTART=20150201T220500Z;INTERVAL=50;WKST=MO',
    '+0300');
  equal(text1, 'Every 50 minutes starting on February 2nd 2015 at 01:05:00 AM +03:00');
  var text2 = subject.recurrenceRuleToText(
    'FREQ=MINUTELY;DTSTART=20150305T210000Z;INTERVAL=1;WKST=MO',
    '+0300');
  equal(text2, 'Every minute starting on March 6th 2015 at 12:00:00 AM +03:00');
  var text3 = subject.recurrenceRuleToText(
    'FREQ=MINUTELY;DTSTART=20150305T210000Z;WKST=MO',
    '+0300');
  equal(text3, 'Every minute starting on March 6th 2015 at 12:00:00 AM +03:00');
  var text4 = subject.recurrenceRuleToText(
    'FREQ=MINUTELY;DTSTART=20150305T210000Z;WKST=MO;BYDAY=MO,WE,SA,SU',
    '+0300');
...
test('parsing secondly rrule interval', function() {
  ...
  var text1 = subject.recurrenceRuleToText(
    'FREQ=SECONDLY;DTSTART=20150201T220500Z;INTERVAL=50;WKST=MO',
    '+0300');
  equal(text1, 'Every 50 seconds starting on February 2nd 2015 at 01:05:00 AM +03:00');
  var text2 = subject.recurrenceRuleToText(
    'FREQ=SECONDLY;DTSTART=20150305T210000Z;INTERVAL=1;WKST=MO',
    '+0300');
  equal(text2, 'Every second starting on March 6th 2015 at 12:00:00 AM +03:00');
  var text3 = subject.recurrenceRuleToText(
    'FREQ=SECONDLY;DTSTART=20150305T210000Z;WKST=MO',
    '+0300');
  equal(text3, 'Every second starting on March 6th 2015 at 12:00:00 AM +03:00');
  var text4 = subject.recurrenceRuleToText(
    'FREQ=SECONDLY;DTSTART=20150305T210000Z;WKST=MO;BYDAY=MO,WE,SA,SU',
    '+0300');
