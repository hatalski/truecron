...
export default Locale.extend({
  ...
  messages: {
    ...
    landing: {
      ...
      moto1: 'Interested?',
      footer: '© {current-year} TrueCron. All rights reserved. TrueCron is a registered trademark of Naviam, Inc.',
      footer2: 'Terms, conditions, features, availability, pricing, fees, service and support options subject to change without notice.',
      beta_invite: {
        header: 'Interested?',
